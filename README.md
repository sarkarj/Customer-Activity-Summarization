...
|---------------|----------------|-------------|
| **Trigger** | Power Automate Flow | On-demand activation via Dynamics 365 |
| **Data Layer** | Dataverse (FetchXML) | Efficient retrieval of top 4 completed activities |
| **AI Engine** | AI Builder Text Prediction | Zero-training summarization model |
| **Integration** | Native Dynamics 365 | Seamless user experience |
